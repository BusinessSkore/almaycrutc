        ...
        <fieldset>
          ...
          <div class="form-group">
            <div class="grid-jun">
              <!-- Start Fields -->
              <p>
                <span class="bold"> No.: </span>{{ formatSecuence(activo.no) }}
              </p>

              <p>
                <span class="bold"> Fecha: </span>{{ formatDate(activo.fecha) }}
              </p>
              <p>
                <span class="bold"> Cant.: </span>{{ formatNumber2(activo.cant) }}
              </p>
              <p>
                <span class="bold"> Valor: </span>{{ formatNumber(activo.valor) }}
              </p>
              ...
              <!-- <div>
                <label
                  ...
                  for="origen"
                  >Orígen:</label
                ><select id="origen" v-model="activo.origen" class="form-select">
            ...
            <div class="grid">
              <p><span class="bold"> Empleado: </span>{{ activo.empleado }}</p>
            </div>
            ...
            <div v-if="this.modoForm == 'show'" class="grid">
              <table id="customers">
                ...
                <!-- <tr style="font-weight: bold">
                  <td>Total: {{ this.totales.cantActivos }}</td>
                  <td></td>
                  <td class="ta-r">
                    {{ formatNumber(this.totales.activos) }}
                  </td>
                </tr> -->
              </table>
            </div>
          ...
          <!-- <button
            ...
            :disabled="!activo.fecha || !activo.empleado || !activo.valor"
          >
...
export default defineComponent({
  ...
  async mounted() {
    ...
    if (this.modoForm == "add") {
      ...
      this.fixTime();
      this.toPrint();
      this.$store.state.user.currentActivo += 1;
      if (
        this.$store.state.user.currentActivo ==
        this.$store.state.user.activosID.length
      ) {
        this.$store.state.user.isPrinting = false;
      }
      this.$router.push(`/nominas/${this.$store.state.user.nomina}`);
    }
