    ...
    <Transition>
      <div v-show="!cargando" class="general">
          ...
          <div v-if="showModal" class="modal">
            <div class="contenedor">
              ...
              <div class="contenido">
                ...
                <div class="contenido">
                  <Filters
                    :filterNominas="filterNominas"
                    :search="search"
                    :filteredNominas="filteredNominas"
                  />
                </div>
              </div>
            </div>
        ...
        > -->
            ...
            <ListadoComponent :nominas="nominas" v-show="!cargando" />
          </div>
        </div>
      </div>
    </Transition>
...
<script lang="ts">
import Filters from "@/components/Nomina/FiltersComponent.vue";
import ListadoComponent from "@/components/Nomina/ListComponent.vue";
import Navbar from "@/components/Navbar.vue";
import { Nomina } from "@/interfaces/Nomina";
import { getNominas } from "@/services/almaycru/Nomina";
...
export default {
  ...
  methods: {
    ...
    async filterNominas(catName: string) {
      try {
        const res = await getNominas();
        this.nominas = res.data;
      } catch (error) {
        // console.error(error);
      }
      // if (catName !== "Todos") {
...
.grid {
  ...
  grid-template-areas:
    ...
    "nominas nominas nominas nominas nominas nominas nominas";
}
